...
import type { {{cookiecutter.entity_name}}, {{cookiecutter.entity_name}}Email, {{cookiecutter.entity_name}}Invoice, {{cookiecutter.entity_name}}Log } from '../types/{{cookiecutter.entity_name_lowercase}}';

const now = new Date();

class {{cookiecutter.entity_name}}Api {
  get{{cookiecutter.entity_name}}s(): Promise<{{cookiecutter.entity_name}}[]> {
    const {{cookiecutter.entity_name_lowercase}}s: {{cookiecutter.entity_name}}[] = [
      {
    ...
    return Promise.resolve({{cookiecutter.entity_name_lowercase}}s);
  }

  get{{cookiecutter.entity_name}}(): Promise<{{cookiecutter.entity_name}}> {
    const {{cookiecutter.entity_name_lowercase}}: {{cookiecutter.entity_name}} = {
      id: '5e86805e2bafd54f66cc95c3',
    ...
    return Promise.resolve({{cookiecutter.entity_name_lowercase}});
  }

  get{{cookiecutter.entity_name}}Emails(): Promise<{{cookiecutter.entity_name}}Email[]> {
    const emails: {{cookiecutter.entity_name}}Email[] = [
      {
  ...
  get{{cookiecutter.entity_name}}Invoices(): Promise<{{cookiecutter.entity_name}}Invoice[]> {
    const invoices: {{cookiecutter.entity_name}}Invoice[] = [
      {
        id: '528651571NT',
  ...
  get{{cookiecutter.entity_name}}Logs(): Promise<{{cookiecutter.entity_name}}Log[]> {
    const logs: {{cookiecutter.entity_name}}Log[] = [
      {
...
export const {{cookiecutter.entity_name_lowercase}}Api = new {{cookiecutter.entity_name}}Api();
