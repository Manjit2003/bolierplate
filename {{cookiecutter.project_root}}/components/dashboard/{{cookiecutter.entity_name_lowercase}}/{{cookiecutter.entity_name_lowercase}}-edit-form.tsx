...
interface {{cookiecutter.entity_name}}EditFormProps {
  {{cookiecutter.entity_name_lowercase}}: {{cookiecutter.entity_name}};
}

export const {{cookiecutter.entity_name}}EditForm: FC<{{cookiecutter.entity_name}}EditFormProps> = (props) => {
  const { {{cookiecutter.entity_name_lowercase}}, ...other } = props;
  const formik = useFormik({
    initialValues: {
      ...
      hasDiscount: {{cookiecutter.entity_name_lowercase}}.hasDiscount || false,
      isVerified: {{cookiecutter.entity_name_lowercase}}.isVerified || false,
      name: {{cookiecutter.entity_name_lowercase}}.name || '',
    ...
    onSubmit: async (values, helpers): Promise<void> => {
      try {
        ...
        toast.success('{{cookiecutter.entity_name}} updated!');
      } catch (err) {
        console.error(err);
  ...
  return (
    ...
    >
      <Card>
        <CardHeader title="Edit {{cookiecutter.entity_name_lowercase}}" />
        <Divider />
        <CardContent>
          <Grid
            container
...
{{cookiecutter.entity_name}}EditForm.propTypes = {
  // @ts-ignore
  {{cookiecutter.entity_name_lowercase}}: PropTypes.object.isRequired
};
